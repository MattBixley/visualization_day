...
- **a)** solidify the template of ggplot2 in the mind of the users, so that they can remember and confidently create a basic plot and 

- **b)** introduce new geoms, familiarise ourselves with the use of arguments for different visual looks 
